  ...
  return (
    <>
      ...
      <div style={{ width: "100%", marginTop: "20px" }}>
        <img
          src="https://logan.nnnow.com/content/dam/nnnow-project/27-sep-2021/SkincareDesktop.jpg"
          alt=""
          width="100%"
        />
      </div>
      ...
      <div style={{ display: "flex" ,width:"100%" }}>
        ...
        >
          <li>MOISTURIZERS</li>
          <li>CLEANSERS</li>
          <li>TREATMENTS & HIGHTECH TOOLS</li>
          <li> MASKS</li>
          <li> BATH & SHOWER</li>
        ...
        <div>
          <img
            src="https://logan.nnnow.com/content/dam/nnnow-project/22-april-2020/tom-ford-cat2/13APR20_SKINCARE_CB_STRIP1_DESK_1.jpg"
            alt=""
            width="100%"
          />
          <Carousel
          ...
          <br />
          <img
            src="https://logan.nnnow.com/content/dam/nnnow-project/17-april-2020/13APR20_SKINCARE_CB_STRIP2_DESK.jpg"
            alt=""
            width="100%"
          />
          <Carousel
          ...
          <br />
          <img
            src="https://logan.nnnow.com/content/dam/nnnow-project/29-may-2020/28MAY20_SKINCARE_SHELF3_DESK.jpg"
            alt=""
            width="100%"
          />
          <Carousel
          ...
          <br />
          <img
            src="https://logan.nnnow.com/content/dam/nnnow-project/17-april-2020/13APR20_SKINCARE_CB_STRIP3_DESK.jpg"
            alt=""
            width="100%"
          />
          <Carousel
