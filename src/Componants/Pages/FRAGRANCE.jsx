  ...
  return (
    <>
      ...
      <div style={{width:"100%",marginTop:"20px"}}>
        <img src="https://logan.nnnow.com/content/dam/nnnow-project/27-sep-2021/FragranceDesktop.jpg" alt="" width="100%" />
      </div><br /><br />
    <div style={{ display: "flex" ,width:"100%"}}>
      <div style={{paddingTop:"90px",width:"50%",fontSize:"25px",fontWeight:"700",}}>
        <li>WOMEN</li>
        <li>MEN</li>
        <li>SHOP BY FRAGRANCE FAMILY</li>
        <li>TOP BRANDS</li>
      </div>
      <div>
        <img
          src="https://logan.nnnow.com/content/dam/nnnow-project/16-april-2020/fragrance/13APR20_FRAGRANCES_CB_STRIP1_DESK_1.jpg"
          alt=""
          width="100%"
        />
        <Carousel
        ...
        <img
          src="https://logan.nnnow.com/content/dam/nnnow-project/16-april-2020/fragrance/13APR20_FRAGRANCES_CB_STRIP2_DESK.jpg"
          alt=""
          width="100%"
        />
        <Carousel
        ...
        <img
          src="https://logan.nnnow.com/content/dam/nnnow-project/16-april-2020/fragrance/13APR20_FRAGRANCES_CB_STRIP3_DESK.jpg"
          alt=""
          width="100%"
        />
        <Carousel
        ...
        <img
          src="https://logan.nnnow.com/content/dam/nnnow-project/18-feb-2022/Deo_Shelf_Desk.jpg"
          alt=""
          width="100%"
        />
        <Carousel
